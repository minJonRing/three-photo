...
export default {
    ...
    methods: {
        init() {
            ...
            // 地面
            this.createReflectorPlane(scene)
            // 显示网格
            // var gridXZ = new THREE.GridHelper(600, 600);
            // scene.add(gridXZ);
            // 坐标轴辅助器
            ...
            const animate = () => {
                ...
                if (ModelPerson) {
                    ...
                    ModelPerson.position.addScaledVector(direction, moveZ);
                    ModelPerson.position.addScaledVector(right, moveX);
                    camera.position.addScaledVector(direction, moveZ);
